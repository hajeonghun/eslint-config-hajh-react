# Hajh React/JSX Style Guide

*A mostly reasonable approach to React and JSX*

Hajh-React React/JSX 스타일 가이드는 [Airbnb React/JSX 스타일 가이드](https://github.com/airbnb/javascript/blob/master/react/README.md) 를 기준으로 작성되었습니다.  
(TODO: 번역 예정)
## Table of Contents
